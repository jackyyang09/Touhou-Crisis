...
public class OptimizedTransitionTweenEditor : OptimizedTransitionBaseEditor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (tweenersFoldout)
        {
            ...
            {
                tweeners.InsertArrayElementAtIndex(tweeners.arraySize);
                tweeners.GetArrayElementAtIndex(tweeners.arraySize - 1).FindPropertyRelative("rect").objectReferenceValue = null;
            }
