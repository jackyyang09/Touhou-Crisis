...
namespace SindenUnity
{
    ...
    public class DynamicBorderEditor : Editor
    {
        DynamicBorder myScript = null;

        private void OnEnable()
        {
            myScript = target as DynamicBorder;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField(
                "A DynamicBorder will listen for changes to the active Sinden Border and " +
        ...
        [MenuItem("GameObject/SindenBorder4Unity/DynamicBorder", false, 11)]
        public static void AddSindenBorder()
        {
            GameObject newObject = new GameObject("DynamicBorder");
            ...
            if (!canvas)
            {
                ...
                Undo.RegisterCreatedObjectUndo(canvasParent, "Added new parent for DynamicBorder");
            }
            ...
            newObject.AddComponent<DynamicBorder>();

            Selection.activeGameObject = newObject;
            Undo.RegisterCreatedObjectUndo(newObject, "Added new DynamicBorder");
        }
    }
}