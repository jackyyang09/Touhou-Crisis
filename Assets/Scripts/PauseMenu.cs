...
public class PauseMenu : MonoBehaviour
{
    ...
    public void ApplyMasterVolume()
    {
        ...
        PlayerPrefs.SetFloat(MasterVolumeKey, AudioManager.MasterVolume);
    }

    public void ApplyMusicVolume()
    {
        AudioManager.SetMusicVolume(musicSlider.value);
        PlayerPrefs.SetFloat(MusicVolumeKey, AudioManager.MusicVolume);
    }

    public void ApplySoundVolume()
    {
        AudioManager.SetSoundVolume(soundSlider.value);
        PlayerPrefs.SetFloat(SoundVolumeKey, AudioManager.SoundVolume);
    }
