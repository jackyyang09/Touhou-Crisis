...
[AddComponentMenu("Event/RailShooter Input Module")]
/// <summary>
...
/// </remarks>
public class RailShooterInputModule : PointerInputModule
{
    ...
    protected RailShooterInputModule()
    {
    }
    ...
    {
        var data = GetMousePointerEventData(0).GetButtonState(PointerEventData.InputButton.Left).eventData;
        if (data.buttonState == PointerEventData.FramePressState.Pressed &&
            data.buttonState != PointerEventData.FramePressState.NotChanged) return;
        data.buttonState = PointerEventData.FramePressState.PressedAndReleased;
